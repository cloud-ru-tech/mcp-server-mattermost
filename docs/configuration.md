...
| `MATTERMOST_MAX_KEEPALIVE_CONNECTIONS` | 20 | Max idle keepalive connections, clamped to max connections (0-1000) |
| `MATTERMOST_KEEPALIVE_EXPIRY` | 30.0 | Seconds an idle keepalive connection stays in the pool (0-600) |
